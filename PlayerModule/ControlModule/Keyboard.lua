...
function Keyboard:UpdateMovement(inputState)
	...
	if self.moveVector ~= Vector3.zero then
		self.moveVector = self.moveVector.Unit
	end
end
...
function Keyboard:BindContextActions()
	...
	local handleJumpAction = function(actionName, inputState, inputObject)
		self.jumpRequested = Settings.JumpEnabled and inputState == Enum.UserInputState.Begin or false --self.jumpEnabled and (inputState == Enum.UserInputState.Begin)
		self:UpdateJump()
		return Enum.ContextActionResult.Pass
	end
