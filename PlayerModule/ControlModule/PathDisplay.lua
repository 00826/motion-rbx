...
local function renderPoint(point, isLast)
	...
	local hitPart, hitPoint, hitNormal = Raycast.RayBlacklist(point + Vector3.new(0, 2, 0), Vector3.new(0, -8, 0), table.create(1, LocalPlayer.Character))
	if not hitPart then
		return
	end
