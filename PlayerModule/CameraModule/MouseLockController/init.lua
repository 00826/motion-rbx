...
function MouseLockController:GetMouseLockOffset()
	...
	if offsetValueObj and offsetValueObj:IsA("Vector3Value") then
		...
		--offsetValueObj.Value = Vector3.new(0, 3, 0)
		offsetValueObj.Value = ForkSettings.ShiftlockOffset
	...
	return ForkSettings.ShiftlockOffset
end
...
function MouseLockController:OnMouseLockToggled()
	...
	if self.isMouseLocked then
		...
		if cursorImageValueObj and cursorImageValueObj:IsA("StringValue") and cursorImageValueObj.Value then
			...
			cursorImageValueObj.Value = ForkSettings.ShiftlockCursor
			cursorImageValueObj.Parent = script
			self.savedMouseCursor = Mouse.Icon
			Mouse.Icon = ForkSettings.ShiftlockCursor
		end
	else
