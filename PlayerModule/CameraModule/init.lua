--[[
	...
	2023 PlayerModule Fork - overflowed
--]]
...
function CameraModule.new()
	...
	--mobile shiftlock was possible this whole time LOL
	if Settings.ShiftlockMobile then
...
function CameraModule:OnCameraSubjectChanged()
	if self.activeTransparencyController then
		self.activeTransparencyController:SetSubject(workspace.CurrentCamera.CameraSubject)
	end
